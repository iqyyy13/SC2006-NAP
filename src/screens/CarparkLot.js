...
const CarparkLot = () =>{
  ...
  const onSavePressed = () => {
    console.warn("Save Carpark Lot"); 
    navigation.navigate("SaveCL")
  }
    ...
    <SafeAreaView style = {{ flex: 1, backgroundColor: '#e8ecf4'}}>
      <View style = {styles.container}>
        <View style = {styles.header}>
          ...
          <Text style = {styles.title} > Carpark Lot </Text>
        ...
        <View style = {styles.form}>
          <View style ={styles.formAction}>
            <TouchableOpacity 
              ...
              <View style = {styles.button}>
                <Text style = {styles.buttonText}>Save Carpark Lot </Text>
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View style = {styles.forgetPassword}>
            <TouchableOpacity
              ...
              <View style = {styles.button}>
                <Text style = {styles.buttonText}>View Saved Carpark Lots </Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>         
